...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Statistic::create(['label' => 'Projects Completed', 'value' => 24, 'order_index' => 1]);
        Statistic::create(['label' => 'Internship Experiences', 'value' => 3, 'order_index' => 2]);
        Statistic::create(['label' => 'Certifications Obtained', 'value' => 12, 'order_index' => 3]);
        Statistic::create(['label' => 'Years Learning Stack', 'value' => 4, 'order_index' => 4]);
        ...
        $coreEng = SkillCategory::create(['name' => 'Core Engineering', 'icon' => 'fa-terminal', 'order_index' => 1]);
        Skill::create(['skill_category_id' => $coreEng->id, 'name' => 'Backend & Architecture (Node.js/Laravel/FastAPI)', 'proficiency_percentage' => 92]);
        Skill::create(['skill_category_id' => $coreEng->id, 'name' => 'Frontend Architecture (React/Modern JS)', 'proficiency_percentage' => 85]);
        Skill::create(['skill_category_id' => $coreEng->id, 'name' => 'Systems & APIs (RESTful/GraphQL/gRPC)', 'proficiency_percentage' => 88]);

        $cloudInfra = SkillCategory::create(['name' => 'Cloud Infrastructure', 'icon' => 'fa-server', 'order_index' => 2]);
        Skill::create(['skill_category_id' => $cloudInfra->id, 'name' => 'Containers & Virtualization (Docker)', 'proficiency_percentage' => 90]);
        Skill::create(['skill_category_id' => $cloudInfra->id, 'name' => 'Relational Data (MySQL/PostgreSQL Structures)', 'proficiency_percentage' => 89]);
        Skill::create(['skill_category_id' => $cloudInfra->id, 'name' => 'AI Agent Modeling & Vectors', 'proficiency_percentage' => 80]);

        // Seed Tag Luar (Other Skills)
        $otherCat = SkillCategory::create(['name' => 'Other Competences', 'icon' => 'fa-tags', 'order_index' => 3]);
        ...
        foreach ($tags as $tag) {
            Skill::create(['skill_category_id' => $otherCat->id, 'name' => $tag, 'is_featured_tag' => true]);
        }
        ...
        Certification::create(['title' => 'Advanced Cloud & Container Architecture', 'issuer' => 'AWS Cluster Node Group', 'year' => 2025]);
        Certification::create(['title' => 'Enterprise Microservice Scalability Credentials', 'issuer' => 'Global Engineering Association', 'year' => 2026]);
        Certification::create(['title' => 'Fullstack System Engineering Frameworks Certification', 'issuer' => 'Tech Institute Consortium', 'year' => 2024]);
        Certification::create(['title' => 'Interactive Human Interface Design System Principles', 'issuer' => 'Design Core Academy', 'year' => 2025]);
